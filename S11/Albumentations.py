...
import numpy as np
import random
from albumentations import HorizontalFlip, Compose, RandomCrop, Normalize, Rotate, pytorch,Cutout
...
class albTransforms(): 
  def __init__(self, train = True):
    ...
    if train:
      ...
      transformsList += [Cutout(num_holes=1,max_h_size=8, max_w_size=8, p=0.5)]
